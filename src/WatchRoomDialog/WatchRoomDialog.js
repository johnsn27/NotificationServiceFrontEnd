    ...
    render() {
        ...
        return (
            <DialogInstance
                ...
                dialogFooter={<div>
                    <button onClick={() => {room.room.Availability === 'Available' ? bookRoom(1, room.room.id, document.getElementById('meeting-name').value, room.start, room.end) : watchRoom(1, room.room.id, 0, room.start, room.end)
