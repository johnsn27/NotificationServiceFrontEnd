...
describe('Login', () => {
    ...
    it('contains upcoming meeting table', () => {
        ...
        // expect(firstRowColumns.length).to.equal(4)
        ...
        // expect(secondRowColumns.length).to.equal(4)
        ...
        // expect(thirdRowColumns.length).to.equal(4)
        ...
        // expect(fifthRowColumns.length).to.equal(4)
    ...
    it('contains watched meeting table', () => {
        ...
        // const thirdRowColumns = element.second().find('td').map(column => column.text())
        ...
        // const fourthRowColumns = element.third().find('td').map(column => column.text())
        // expect(fourthRowColumns.length).to.equal(3)
        ...
        // const fifthRowColumns = element.fourth().find('td').map(column => column.text())
        // expect(fifthRowColumns.length).to.equal(3)
        // expect(firstRowColumns[0]).to.equal('Project')
        // expect(firstRowColumns[1]).to.equal('NBH 06 E M2 Studio 1')
        // expect(firstRowColumns[2]).to.equal('15/04/2019 at 17:00')

        // const sixthRowColumns = element.fifth().find('td').map(column => column.text())
        // expect(sixthRowColumns.length).to.equal(3)
