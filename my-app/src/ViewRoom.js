...
class ViewRoom extends Component {
  ...
  render() {
    return (
      <div>
        <div className="ViewRoomTitle">
          Studio 1 06 E M1
            </div>
        <div className="ViewRoomContents">
          <div className="ViewRoomContentsLeft">
            <div className="ImageContent">
              ...
              <div className="WatchBookCollection">
          ...
          <div className="ViewRoomContentsRight">
